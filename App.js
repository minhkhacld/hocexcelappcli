    ...
    return (
      <HomeStack.Navigator initialRouteName="Home">
        ...
        <HomeStack.Screen
          name="ListItem"
          component={ListItems}
          options={({route}) => ({title: reducer.listItemHeaderBarName})}
        />
        <HomeStack.Screen
          name="ListItemDetail"
          options={{
        ...
        <HomeStack.Screen
          ...
          options={{title: 'Phím tắt và công dụng', headerShown: false}}
        />
      </HomeStack.Navigator>
    );
  };
    ...
    return (
      <AboutStack.Navigator initialRouteName="About">
        ...
        <AboutStack.Screen
          ...
          options={({route}) => ({title: 'Liên hệ và hỗ trợ'})}
        />
        <AboutStack.Screen
          name="GoPremium"
          component={GoPremium}
          options={({route}) => ({title: 'Nâng cấp bản Premium'})}
        />
        ...
        <Tab.Navigator
          ...
          screenOptions={({route}) => ({
            ...
            tabBarInactiveTintColor:
              route.name === 'HomeTab'
                ? 'grey'
                : route.name === 'QuizGameTab'
                ? 'white'
                : route.name === 'YouTubeTab'
                ? 'black'
                : 'white',
          ...
          <Tab.Screen
            name="QuizGameTab"
            component={QuizGameStackScreen}
            options={{headerShown: false, tabBarShowLabel: false}}
          />
          <Tab.Screen
            name="YouTubeTab"
            component={YouTubeLessonScreen}
            options={{headerShown: false, tabBarShowLabel: false}}
          />
          <Tab.Screen
            name="AboutTab"
