...
import { GoLeft, GoRight } from './src/components/header/handleNavigation';
//Icon
  ...
  const HomeStackScreen = () => {
    ...
    return (
      <HomeStack.Navigator initialRouteName="Home" >
        ...
        <HomeStack.Screen name="ListItemDetail" component={ListItemDetail} options={{
  ...
  const QuizGameStackScreen = ({ navigation }) => {
    return (
      <QuizGameStack.Navigator initialRouteName="QuizGame" >
        <QuizGameStack.Screen name="QuizGame" component={QuizGame} options={{
          headerShown: false,
        }} />
    ...
    return (
      ...
      >
        <AboutStack.Screen name="About" component={About} options={{
          title: "Giới thiệu", headerLeft: () => (
            <GoLeft navigation={navigation} location={'QuizGameTab'} />
          ),
          headerRight: () => (
            <GoRight navigation={navigation} location={'HomeTab'} />
          ),
        }} />
