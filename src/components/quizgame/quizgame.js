...
const QuizGame = ({ navigation }) => {
  ...
  const adUnitId = __DEV__
    // ? TestIds.REWARDED
    ? "ca-app-pub-3940256099942544/5224354917" : 'ca-app-pub-8774393929760728/9059780648';
  ...
  const handleNext = () => {
    ...
    if (ignoreWrongAsw.count > 0) {
      if (currentQuestionIndex == state.DATA.length - 1) {
        //show modal
        navigation.navigate('QuizGameResult', {
          score,
          QuestionLength: state.DATA.length,
        });
      } else {
    ...
    <SafeAreaView style={styles.container}>
        ...
        {state.DATA.length > 0 && (
          <View style={styles.content}>
            <View style={styles.score}>
              <View style={styles.iconGroupTop}>
                ...
                <Text style={styles.scoreText}>
                  {`${currentQuestionIndex + 1}/${state.DATA.length}`}
                </Text>
              </View>
              <View style={styles.iconGroupTop}>
                <Icon
            ...
            <View style={styles.question}>
              <View style={styles.questionContent}>
                <Text style={styles.questionText}>
                  {state.DATA[currentQuestionIndex].question}
                </Text>
              </View>
              {/* <Banner /> */}
            </View>
            <View style={styles.options}>
              {state.DATA.length > 0 &&
                state.DATA[currentQuestionIndex].option.map((option, index) => {
                  return (
                    <TouchableOpacity
                      key={index}
                      style={[
                      ...
                      disabled={
                        isOptionDisabled || ignoreWrongAsw.count === 0
                          ? true
                          : false
                      }
                      onPress={() => {
            ...
            <View style={styles.handle}>
              <LinearGradient
                ...
                <TouchableOpacity
                  ...
                  onPress={() => storeData(currentQuestionIndex, score)}>
                  <Icon
              ...
              <LinearGradient
                ...
                <TouchableOpacity
                  ...
                  <Text style={styles.nextbtnText}>
                    {ignoreWrongAsw.count === 0 ? 'Lấy chìa' : 'Kế tiếp'}
                  </Text>
                </TouchableOpacity>
              </LinearGradient>
            </View>
      ...
      {modalVisible && (
        <ModalClaimReward
          ...
          ignoreWrongAsw={ignoreWrongAsw}
          setIgnoreWrongAsw={setIgnoreWrongAsw}
          // rewarded={rewarded}
          showRewardAd={show}
        />
      )}
